...
export const ApolloLogo: React.FC<ApolloLogoProps> = ({ theme = 'dark' }) => {
    const textColor = theme === 'dark' 
        ? 'text-slate-200 group-hover:text-amber-300' 
        : 'text-slate-800 group-hover:text-apollo-orange';
    ...
    return (
        <div className="flex items-center space-x-2">
            ...
            <div className={`flex items-baseline text-xl font-bold tracking-wider ${textColor} transition-colors duration-500`}>
